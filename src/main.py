...
def combine_points():
  ...
  if len(pois1) > 0:
    if len(pois2) > 0:
      ...
      world_point = SpottedCoordinate(abs_point[0], abs_point[1], abs_point[2])
...
#     fixture.location = fixture.location.displace_by(SpottedCoordinate(0.01, 0, 0))
#     fixture.point_at(SpottedCoordinate(0, 0, 0))
...
fixture.point_at(SpottedCoordinate(1, 0, 0))
fixture.point_at(SpottedCoordinate(0, 1, 0))
fixture.point_at(SpottedCoordinate(0, 0, 1))
fixture.point_at(SpottedCoordinate(1, 1, 1))
fixture.point_at(SpottedCoordinate(-1, 0, 0))
fixture.point_at(SpottedCoordinate(0, -1, 0))
fixture.point_at(SpottedCoordinate(0, 0, -1))
fixture.point_at(SpottedCoordinate(-1, -1, -1))
...
#     for z in range(4):
#       for fixture in universes.universes[0].fixtures:
#         fixture.point_at(SpottedCoordinate(x, 0, z))
